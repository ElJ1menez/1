...
import numpy as np
# MODIFIED for AI Motion Tracker (Blender add-on): the two imports below were
# changed from `from tapnet.torch import ...` to relative imports so the
# vendored copy works without installing the tapnet package. No other changes.
from . import nets
from . import utils
import torch
