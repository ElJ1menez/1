...
GROUPS = {
    ...
    "torch": {
        "label": "PyTorch (BootsTAPIR)",
        "modules": ("torch", "tree", "einshape"),
        "packages": ("torch", "dm-tree", "einshape"),
        "license": "BSD-3 / Apache-2.0",
    },
    "mediapipe": {
        "label": "MediaPipe (cuerpo, cara, segmentación)",
        "modules": ("mediapipe",),
        "packages": ("mediapipe",),
        "license": "Apache-2.0",
    },
...
def init_paths():
    try:
        ...
        base = bpy.utils.user_resource("DATAFILES", path="ai_motion_tracker", create=True)
